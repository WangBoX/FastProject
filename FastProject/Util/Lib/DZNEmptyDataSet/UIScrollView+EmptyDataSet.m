...
- (NSAttributedString *)dzn_titleLabelString
{
    ...
    return [EmptyDataManager titleForEmptyView];
}
...
- (NSAttributedString *)dzn_detailLabelString
{
    ...
    return [EmptyDataManager descriptionForEmptyView:nil];
}
...
- (UIImage *)dzn_image
{
    ...
    return [EmptyDataManager imageForEmptyView];
}
...
- (CAAnimation *)dzn_imageAnimation
{
    ...
    return [EmptyDataManager imageAnimationForEmptyView];
}
...
- (NSAttributedString *)dzn_buttonTitleForState:(UIControlState)state
{
    ...
    return [EmptyDataManager buttonTitleForEmptyViewForState:state];;
}
...
- (UIImage *)dzn_buttonBackgroundImageForState:(UIControlState)state
{
    ...
    return [EmptyDataManager buttonBackgroundImageForEmptyViewForState:state];
}
...
- (UIColor *)dzn_dataSetBackgroundColor
{
    ...
    return [EmptyDataManager backgroundColorForEmptyView];
}
...
- (CGFloat)dzn_verticalOffset
{
    ...
    return [EmptyDataManager verticalOffsetForEmptyView];
}
...
- (CGFloat)dzn_verticalSpace
{
    ...
    return [EmptyDataManager spaceHeightForEmptyView];
}
